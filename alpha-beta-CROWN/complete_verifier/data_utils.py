...
def load_dataset():
    ...
    elif arguments.Config["data"]["dataset"] == 'tiny_imageNet':
        loader = datasets.ImageFolder

    else:
        raise ValueError("Dataset {} not supported.".format(arguments.Config["data"]["dataset"]))
    
    if arguments.Config["data"]["dataset"] != 'tiny_imageNet':
        ...
        test_data = loader(os.path.join(database_path, 'tiny-imagenet-200/val/images_split'),
